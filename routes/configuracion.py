"""
routes/configuracion.py — Endpoints de configuracion de base de datos.
"""
...
def save_db_config():
    ...
    try:
        ...
        try:
            ...
            ddl_msg = f'Config guardada pero DDL fallo: {e}'
        return jsonify({'ok': True, 'message': f'Configuracion guardada. {ddl_msg}'})
    except Exception as e:
